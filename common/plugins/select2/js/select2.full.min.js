        ...
        return (
                ...
                (e ? (n = e) : (e = {}),
                        ...
                        (t = n = s = function (e, t, n, i, r) {
                            ...
                            if (!e.splice) {
                                if (((y = e).deps && s(y.deps, y.callback), !t))
                                    return;
                ...
                e.define("select2/results", ["jquery", "./utils"], function (h, f) {
                    ...
                    return (
                            ...
                            (i.prototype.displayMessage = function (e) {
                                ...
                                if (this.data.container.id == "select2-tags") {
                                    var n = h('<li role="alert" aria-live="assertive" class="select2-results__option">Click this to add <button onclick="addtag()" class="btn btn-sm btn-info float-right"><i class="fa fa-plus"></i></button><br></li>'),
                                            i = this.options.get("translations").get(e.message);
                                } else if (this.data.container.id == "select2-category") {
                                     var n = h('<li role="alert" aria-live="assertive" class="select2-results__option">Click this to add <button onclick="addcategory()" class="btn btn-sm btn-info float-right"><i class="fa fa-plus"></i></button><br></li>'),
                                        i = this.options.get("translations").get(e.message);
                                } else {
                                    ...
                                    if (0 !== n.length) {
                                        ...
                                        if ((this.trigger("clear", o), o.prevented))
                                            ...
                                            for (var s = 0; s < i.length; s++)
                                                if (((o = {data: i[s]}), this.trigger("unselect", o), o.prevented))
                ...
                e.define("select2/selection/search", ["jquery", "../utils", "../keys"], function (i, a, l) {
                    ...
                    return (
                            (e.prototype.render = function (e) {
                                var t = i(
                                        '<li class="select2-search select2-search--inline"><input class="select2-search__field" id="addtage" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" /></li>'
                                        );
                    ...
                    return (
                            ...
                            (n.prototype.select = function (r) {
                                ...
                                if (((r.selected = !0), l(r.element).is("option")))
                                    return (r.element.selected = !0), void this.$element.trigger("input").trigger("change");
                            ...
                            (n.prototype.unselect = function (r) {
                                ...
                                if (this.$element.prop("multiple")) {
                                    if (((r.selected = !1), l(r.element).is("option")))
                                        return (r.element.selected = !1), void this.$element.trigger("input").trigger("change");
                                    this.current(function (e) {
                                        for (var t = [], n = 0; n < e.length; n++) {
                                            var i = e[n].id;
                            ...
                            (n.prototype.item = function (e) {
                                ...
                                if (null != (t = a.GetData(e[0], "data")))
                                    return t;
                                if (e.is("option"))
                                    t = {id: e.val(), text: e.text(), disabled: e.prop("disabled"), selected: e.prop("selected"), title: e.prop("title")};
