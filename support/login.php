...
if(isset($_POST['dataUploaderLogin'])){
    ...
    if(!empty($username && $password)){
        $sql="SELECT * from `tbl_staff` Where email='$username' AND password='$pass' and status=1";
...
<section>
    ...
    <label for="email"><i class="fa fa-envelope"></i> Email:</label>
        <input type="email" id="email" name="username" class="cm-input" placeholder="Email">
