              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                    ...
                    <tbody>
                   <?php 
                   $userdata=$conn->query("SELECT tbl_products.*, tbl_vendors.vend_name FROM (`tbl_products` INNER JOIN tbl_vendors ON tbl_vendors.vendor_id = tbl_products.vendor_id) WHERE tbl_products.product_status = 'rejected' ");
                   $count=0;
