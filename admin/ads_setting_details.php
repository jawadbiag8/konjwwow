          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-heading">
                <h4 class="h4 text-center p-3 bg-info">Ads Content</h4>
              </div>
              <div class="card-body">
              <div class="form-row">
                <div class="col-md-12">
                <a href="classified_setting.php">
                <button class="btn btn-sm btn-danger float-left" data-toggle="modal" data-target="#addStaff">Go Back<i class="fa fa-arrow-left"></i></button>
                </a>
            
                    <button class="btn btn-sm btn-info float-right" data-toggle="modal" data-target="#addStaff">Add Content <i class="fa fa-plus"></i></button>
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                    ...
                    <tbody>
                   <?php 
                   $userdata=$conn->query("SELECT * FROM `tbl_ads_content` where pkg_id='$pkg_id' ");
                   $count=0;
                   ...
                   <tr>
                    ...
                    <td>
                    <button class="btn btn-info btn-sm" value="<?=$row['content_id'];?>"  onclick="delete_member_data(this.value);">Delete</button>
