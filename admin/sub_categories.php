          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-heading">
                <h4 class="h4 text-center p-3 bg-info">Sub Categories</h4>
              </div>
              <div class="card-body">
              <div class="form-row">
                <div class="col-md-12">
                ...
                <div class="table-responsive">
                  <table class="table table-striped table-sm table-hover table-bordered table-condenced" id="table_">
                    ...
                    <tbody>
                   <?php 
                   $userdata=$conn->query("SELECT * FROM `tbl_sub_categories` INNER JOIN tbl_categories ON tbl_categories.cat_id=tbl_sub_categories.cat_id");
                   $count=0;
                   ...
                   <tr>
                    ...
                    <td>
                    <button class="btn btn-info btn-sm" value="<?=$row['sub_cat_id'];?>"  onclick="editorledetails(this.value);">Edit</button>
                    <button class="btn btn-danger btn-sm" value="<?=$row['sub_cat_id'];?>"  onclick="delete_member_data(this.value);">Delete</button>
    ...
    <div class="modal-dialog modal-lg">  
      ...
      <form action="action.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <select name="cat_id" id="" class="form-control">
                    ...
                    <?php 
                   $userdata=$conn->query("SELECT * FROM `tbl_categories` ");
                   $count=0;
                   while($row=$userdata->fetch_assoc()):
                   $count++;
                   ?>
        ...
        <div class="modal-footer">  
          ...
          <button type="submit" name="save_sub_categories" class="btn btn-success btn-sm "> Save</button>
